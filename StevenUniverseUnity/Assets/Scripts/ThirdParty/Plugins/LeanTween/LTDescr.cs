...
public class LTDescr
{
	...
	public void reset()
    {
        //Debug.LogFormat("Resetting Tween {0}", id);
	...
	public LTDescr setCanvasMove(){
		...
		this.initInternal = ()=>
        {
            ...
            //Debug.LogFormat("Setting from on tween : {0}", fromInternal);
        };
	...
	private void init(){
        ...
        //Debug.LogFormat("Initing diff, From {0} to {1}", from, to);
		this.diff = this.to - this.from;
		this.diffDiv2 = this.diff * 0.5f;
	...
	*/
	...
	public LTDescr setEaseShake()
    {
        ...
        //Debug.LogFormat("Setting ease shake from {0} to {1}", from.x, to.x);
        this.toInternal.x += this.from.x;
	...
	private Vector3 tweenOnCurve(){
        ...
        //Debug.LogFormat("Ratio {0} Diff {1} From {2}", r, diff, from.x);
