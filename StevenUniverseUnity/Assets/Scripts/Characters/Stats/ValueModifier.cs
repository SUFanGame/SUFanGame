...
public class ValueModifier : System.IEquatable<ValueModifier>, System.IComparable<ValueModifier>
{
    ...
    /// BASE is added to the base value BEFORE percent bonuses.
    /// All PERCENT bonuses are added together than applied to the modified base value.
    /// Finally FLAT modifiers are added at the end, only affecting the final value. 
    /// </summary>
    public enum Type
    {
        BASE_MODIFIER,
